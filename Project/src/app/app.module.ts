...
import { PurchasedbooksresComponent } from './purchasedbooksres/purchasedbooksres.component';
import { PurchasedIdComponent } from './purchased-id/purchased-id.component';
import { PurchasedIdresComponent } from './purchased-idres/purchased-idres.component';
...
@NgModule({
  declarations: [
    ...
    PurchasedbooksresComponent,
    PurchasedIdComponent,
    PurchasedIdresComponent,
